                                            ...
                                            <div class="row">
                                                <div class="col-sm-8">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" id="userid" name="userid" value="babiato" placeholder="User ID" required readonly>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="password" class="form-control" id="purchase_key" value="babiato.co"  name="purchase_key"  placeholder="Purchase Key" required readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
